...
///
/// ```rust
/// use transafe_server::io_tools::read_str;
...
/// # Examples
/// ```rust
/// use transafe_server::io_tools::read_std_line;
...
///
/// ```rust
/// use transafe_server::io_tools::write_to_file;
...
///
/// ```rust
/// use transafe_server::io_tools::write_bytes_to_file;
